// Custom SVG icon set — DO NOT substitute Lucide/Heroicons/Tabler
// Ported verbatim from design/components/shared.jsx
...
export function IconLogo({ size = 20, className }: IconProps) {
  return (
...
export function IconPause({ size = 12, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M6 4h4v16H6zM14 4h4v16h-4z"/></svg>
  );
}

export function IconCheck({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m5 12 5 5L20 7"/></svg>
  );
}
...
export function IconTweak({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className={className}>
